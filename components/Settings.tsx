...
import { User, Shield, Bell, Globe, Camera, Save, Lock, Smartphone, Mail, AlertCircle, Check } from 'lucide-react';

const TABS = [
  { id: 'general', label: 'General', icon: User, description: 'Profile & personal information' },
                  ...
                  <div className="grid grid-cols-2 gap-6">
                     ...
                     <div className="col-span-2">
                        ...
                        <div className="relative">
                           ...
                           <input 
                              type="email" 
                              defaultValue="mujtaba@example.com" 
                              className="w-full bg-dark-accent text-primary rounded-xl pl-12 pr-4 py-3 outline-none focus:ring-1 focus:ring-brand-green border border-transparent transition-all placeholder-secondary/50"
                           />
                        </div>
                     </div>
                     <div className="col-span-2">
