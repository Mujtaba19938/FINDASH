...
import { Search, Bell, Mail, Sun, Moon, Check, X, AlertCircle, Info, CheckCircle, Sparkles } from 'lucide-react';
    ...
    <div className="flex justify-between items-center mb-8 pt-2 relative z-40">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 border-l border-dark-border pl-6 transition-colors">
          ...
          <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-dark-card ml-2 cursor-pointer hover:border-brand-green transition-all shadow-sm">
